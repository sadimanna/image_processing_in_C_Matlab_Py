...
% *Question-2*
%
% *Get the 8-bit image ‘Tagore_Gandhi’. Subtract 128 from each of its
% pixels and show the resultant image and its histogram. Equalize the
% image using the approach of histogram equalization. Repeat the same
% procedure after dividing each of its pixels by a factor of 2.Finally make
% one comparison between these two approaches*
% 
% _*Code*_ ::
%
...
subplot(222)
bar(0:1:255,htg,'FaceColor','c','EdgeColor','k')
xlim([0 140])
title('Manual Histogram')

%Normalizing the Histogram
htgnorm = htg/(stg(1)*stg(2));
